          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <div>
                      ...
                      border border-gray-300 text-gray-900 rounded-lg focus:ring-secondary
                  ...
                  <div class="flex items-center justify-between">
                      <div class="flex items-start">
                          <div class="flex items-center h-5">
                            ...
                            border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-secondary" required="">
                          </div>
                          <div class="ml-3 text-sm">
                            <label for="remember" class="text-gray-500">Remember me</label>
                          </div>
                      </div>
                      <a href="#" class="text-sm font-medium text-secondary hover:underline">Forgot password?</a>
                  </div>
                  <button type="submit" class="w-full text-white bg-secondary hover:bg-blue-900 focus:ring-4 focus:outline-none 
